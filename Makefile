COMPOPT := -std=c++26 -freflection -flto=7 -fuse-linker-plugin -Wall -Wextra -Wpedantic -Wconversion -DSFE_ENABLE_ACHIEVEMENTS -Wsign-conversion -Wno-maybe-uninitialized -Wnrvo -Werror -m64 -I"src/include" -I"/usr/include/freetype2" -I$(cppinclude) -fconcepts-diagnostics-depth=10
